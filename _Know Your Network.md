...
Task:
 1. CoreTAAS must have the following SVIs
   - VLAN 1
       - IP address: 10.72.1.2
       - Description: DEFAULT-VLAN
       - Status: UP

   - VLAN 10
     - IP address: 10.72.10.2
     - Description: WIFI-VLAN
     - Status: UP

   - VLAN 50
     - IP address: 10.72.50.2
     - Description: CCTV-VLAN
     - Status: UP

   - VLAN 100
     - IP address: 10.72.100.2
...
!@CoreBABA
conf t
 ip dhcp excluded-address 10.72.1.1 10.72.1.100
 ip dhcp excluded-address 10.72.10.1 10.72.10.100
 ip dhcp excluded-address 10.72.50.1 10.72.50.100
...
!@CoreBABA
conf t
 ip dhcp excluded-address 10.72.100.1 10.72.100.100
...
conf t
 ...
 dial-peer voice 2 pots
  destination-pattern 7201
  port 0/0/1
 dial-peer voice 3 pots
  destination-pattern 7202
  port 0/0/2
 dial-peer voice 4 pots
  destination-pattern 7203
  port 0/0/3
 end
~~~
...
config t
 dial-peer voice 69 voip
  ...
  destination-pattern 7269
  session target ipv4:10.72.100.8
  incoming called-number 7269
...
conf t
 ...
 ip route 10.72.0.0 255.255.0.0 10.72.72.4 254
 end
~~~
...
conf t
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.72.100.4 254
 end
~~~
...
!@CoreBABA
conf t
 ip route 0.0.0.0 0.0.0.0 10.72.72.1 254
 end
~~~
...
~~~
!@cmd
ping 10.72.1.2                 CoreTAAS
ping 10.72.1.4                 CoreBABA
ping 10.72.100.8               CUCM
ping 10.72.72.1            EDGE
~~~
